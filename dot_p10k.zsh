# Generated by Powerlevel10k configuration wizard on 2024-07-30 at 11:37 EDT.
...
# angled separators, round heads, sharp tails, 2 lines, dotted, right frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*teleport*'  PROD    # These values are examples that are unlikely
      '*cwsa*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=134
